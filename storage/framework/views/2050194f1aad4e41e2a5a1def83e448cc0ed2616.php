    ...
    <a href="#"><img src="http://myweb.joburg/wp-content/uploads/2015/12/My-Website.gif" alt="logo" height="50" width="320" style="margin-top: 10px;"></a>
              ...
              <div class="main_nav_inner">
                ...
                <div class="top-right links">
                    ...
                    <a href="#about"><?php echo e(__('about')); ?></a>
                    <a href="#product"><?php echo e(__('product')); ?></a>
                    <a href="#feature"><?php echo e(__('feature')); ?></a>
                    ...
                    <?php if(Route::has('login')): ?>
                        ...
                        <?php endif; ?>
                    <?php endif; ?>
                    <a href="#contact"><?php echo e(__('contact us')); ?></a>
...
.icon-bar a:hover {
    background-color: #007bb5;
                ...
                <div class="footer">
                  ...
                  <a>&copy; <?php echo e(date('Y')); ?> <?php echo e(config('app.name')); ?>. <?php echo e(__('views.auth.login.copyright')); ?></a>
